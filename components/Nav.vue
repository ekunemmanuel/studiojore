<template>
  <transition name="height">
    <header class="bg-[#ffffff] duration-300 nav fixed top-0 left-0 right-0 z-[100]">
      <nav
        class="main_container duration-300 flex justify-between sm:!py-[1rem] flex-col !py-[.5rem]"
      >
        <div
          class="sm:flex justify-between w-full hidden font-bold text-[18px] uppercase"
        >
          <div class="flex items-center gap-[1rem]">
            <NuxtLink to="/"
              ><NuxtImg alt="Logo" loading="lazy" class="w-[50px]" src="logo-large.png"
            /></NuxtLink>
        ...
        <transition name="slide_left" mode="out-in">
          <div
            v-if="menu_open"
            class="duration-300 font-bold text-[20px] uppercase flex flex-col gap-[1rem]"
          >
            <!-- <NuxtLink to="#subscribe">Subscribe</NuxtLink>
                        <NuxtLink to="#services">Client Services</NuxtLink> -->
